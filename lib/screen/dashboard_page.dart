...
class _DashboardPageState extends State<DashboardPage>
  ...
  // ── State ──────────────────────────────────────────────────────
  int    _selectedCategoryIndex = 0; // 0=All,1=Breakfast,2=Lunch,3=Snacks,4=Drinks
  ...
  // ── Master food list  (category matches index in _categories) ──
  ...
  // ── FILTERED LIST  ← THE FIX ──────────────────────────────────
  // When index == 0  → show ALL foods
  // When index == 1  → show only foods where category == 1  (Breakfast)
  // When index == 2  → show only foods where category == 2  (Lunch)
  // … and so on
  List<Map<String, dynamic>> get _filteredFoods {
    final List<Map<String, dynamic>> byCategory = _selectedCategoryIndex == 0
        ? List.from(_allFoods)
        : _allFoods
            .where((f) => f['category'] as int == _selectedCategoryIndex)
            .toList();
  ...
  void initState() {
    ...
    _searchFade = Tween<double>(begin: 0, end: 1).animate(CurvedAnimation(
        parent: _pageEntryController,
    ...
    // Starts fully visible; we animate it out then in on category change
  ...
  double get _cartTotal => _cart.entries.fold(0.0, (sum, e) {
        final food =
            _allFoods.firstWhere((f) => f['id'] == e.key, orElse: () => {"price": "0"});
      ...
      body: Stack(children: [
        ...
        SafeArea(
          child: LayoutBuilder(builder: (ctx, constraints) {
            ...
            final double hPad =
                isDesktop ? constraints.maxWidth * 0.1 : (isTablet ? 36 : 22);
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: SlideTransition(
                          ...
                          child: FadeTransition(
                              opacity: _heroFade,
                              child: _buildHeroText(constraints.maxWidth)),
                        ),
                      ),
                      ...
                      Padding(
                        padding: EdgeInsets.symmetric(horizontal: hPad),
                        child: FadeTransition(
                            opacity: _searchFade, child: _buildSearchBar()),
                      ),
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: _TodaysMenuButton(
                                onTap: () {
                                  // Navigate or show bottom sheet as needed
    ...
    return Padding(
      ...
      child: Row(children: [
        ...
        _IconBtn(
          ...
          onTap: _goToCart,   // ← routes to CartPage
          isPrimary: true,
        ),
      ]),
    );
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Text("What would you",
          style: GoogleFonts.playfairDisplay(
              ...
              color: AppColors.textDark, height: 1.1)),
      RichText(
        text: TextSpan(
          style: GoogleFonts.playfairDisplay(
              fontSize: fs, fontWeight: FontWeight.w800, height: 1.1),
          children: [
        ...
        itemBuilder: (_, index) {
          ...
          return GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                gradient: sel
                    ? const LinearGradient(colors: [AppColors.primary, Color(0xFFFF8C42)])
                    : null,
              ...
              child: Row(mainAxisSize: MainAxisSize.min, children: [
                Icon(cat['icon'] as IconData,
                    size: 15, color: sel ? Colors.white : AppColors.primary),
  ...
  Widget _buildSectionHeader(double maxWidth) {
    ...
    return Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
      Row(children: [
        Text(title,
            style: GoogleFonts.playfairDisplay(
                fontSize: fs, fontWeight: FontWeight.w800, color: AppColors.textDark)),
        const SizedBox(width: 10),
        Container(
      ...
      child: GridView.builder(
        ...
        itemBuilder: (_, index) {
          ...
          return _FoodCard(
            ...
            onWishlist: () => setState(() =>
                _wishlist.contains(foodId)
                    ? _wishlist.remove(foodId)
                    : _wishlist.add(foodId)),
            onAdd: () => setState(() {
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              gradient: const LinearGradient(
                  colors: [Color(0xFF2D2D2D), Color(0xFF4A2010)]),
              borderRadius: BorderRadius.circular(20),
              boxShadow: [BoxShadow(
...
class _TodaysMenuButtonState extends State<_TodaysMenuButton>
          ...
          child: Row(children: [
            ...
            Expanded(
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Text("See what's available right now",
                    style: GoogleFonts.poppins(
    ...
    return DraggableScrollableSheet(
      ...
      builder: (_, scrollCtrl) => Container(
        ...
        child: Column(children: [
          ...
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 22),
            child: Text("Full menu available today",
          ...
          Expanded(
            child: ListView(
              ...
              children: _sections.map((section) {
                final sectionFoods = foods
                    .where((f) => f['category'] as int == section['category'] as int)
                    .toList();
                return _MenuSection(
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Icon(icon, size: 14, color: isPrimary ? Colors.white : AppColors.primary),
      ),
    );
  }
}
  ...
  Widget build(BuildContext context) {
    return ClipRRect(
      ...
      child: Stack(fit: StackFit.expand, children: [
        Image.network(item['img'] as String, fit: BoxFit.cover,
            ...
            children: [
              ...
              Container(
                ...
                child: Text("Order Now",
                    style: GoogleFonts.poppins(
                        color: colors.first, fontSize: 11, fontWeight: FontWeight.w700)),
              ),
            ],
          ),
        ),
          ...
          child: Row(children: [
            ...
            Stack(children: [
              ClipRRect(
                ...
                child: Image.network(
                  widget.food['img'] as String,
                  width: 110, height: double.infinity, fit: BoxFit.cover,
                  loadingBuilder: (_, child, progress) {
                    if (progress == null) return child;
                    return _ShimmerBox(controller: widget.shimmerController, width: 110);
                  },
                  errorBuilder: (_, __, ___) => Container(
                      width: 110, color: Colors.grey[200],
                      child: const Icon(Icons.broken_image, color: Colors.grey)),
                ),
              ),
              Positioned(
                ...
                child: Container(
                  ...
                  child: Text(widget.food['tag'] as String,
                      style: GoogleFonts.spaceMono(
                ...
                child: Column(
                  ...
                  children: [
                    Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Expanded(
                        child: Text(widget.food['name'] as String,
                            style: GoogleFonts.playfairDisplay(
                      ...
                      GestureDetector(
                        ...
                        child: AnimatedSwitcher(
                          ...
                          child: Icon(
                            ...
                            size: 18,
                            color: widget.isWishlisted ? Colors.redAccent : Colors.black26,
                          ),
                        ),
                      ),
                    ]),
                    Row(children: [
                      ...
                      const SizedBox(width: 3),
                      Text(widget.food['time'] as String,
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [BoxShadow(
                  color: (isPrimary ? AppColors.primary : Colors.black)
                      .withValues(alpha: isPrimary ? 0.3 : 0.05),
                  blurRadius: isPrimary ? 12 : 8, offset: const Offset(0, 4))],
            ),
            child: Icon(icon,
                color: isPrimary ? Colors.white : AppColors.textDark, size: 20),
          ),
          if (badge != null)
            Positioned(
              top: -4, right: -4,
...
class _AnimatedOrb extends StatelessWidget {
  ...
  const _AnimatedOrb({required this.controller, required this.color,
      required this.size, required this.alignment, required this.phaseShift});
